---
title: Send books to the PocketBook Verse Pro with Calibre
pageSlug: send-books
device: pocketbook-verse-pro
section: calibre
type: guide
order: 1
summary: Add EPUB books to Calibre and copy them to the Verse Pro over USB. No conversion is needed, and wireless sending is available through the email plugin.
...
prerequisites:
  - text: "Calibre and the PocketBook Verse Pro — formats and when it helps"
    href: /devices/pocketbook/pocketbook-verse-pro/calibre/
related:
...
steps:
  - instruction: Install Calibre and add your books
    detail: >-
      ...
      metadata".
  - instruction: Connect the Verse Pro with the USB-C cable
    detail: >-
  ...
  - instruction: Send EPUB straight across — no conversion
    detail: >-
      The Verse Pro reads EPUB directly, so leave Calibre's conversion settings
      alone. Only convert if you have a format even the Verse Pro cannot open,
      which is rare; in that case convert to EPUB.
  ...
  - instruction: Find the books on the Verse Pro
    detail: >-
      ...
      restart the Verse Pro from the power menu.
  - instruction: "Optional: send wirelessly by email"
    detail: >-
      In Calibre, open Preferences, then "Sharing books by email", and add the
      Verse Pro's Send-to-PocketBook address and the account Calibre should send
