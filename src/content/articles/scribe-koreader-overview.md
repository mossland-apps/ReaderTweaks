---
title: KOReader on the Kindle Scribe
device: scribe
section: koreader
type: overview
...
now, and even if there were, it would turn off the features you bought the
Scribe for.
...
- **KOReader has no pen support.** It is a reading app. It does not do
  handwriting, notebooks, in-book notes or PDF markup. On the Scribe you would
  lose all of that the moment you opened it.

## What to do instead

- For **typography and PDF reflow**, the Scribe's own reader has improved and
  handles large-page PDFs well. For dense PDFs, zoom and pan, or read them on a
  computer.
