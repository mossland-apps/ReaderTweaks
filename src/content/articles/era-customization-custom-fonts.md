---
title: Add your own fonts to the PocketBook Era
pageSlug: custom-fonts
device: pocketbook-era
section: customization
type: guide
order: 1
summary: Copy TrueType or OpenType fonts to a folder on the Era and select them from the reading menu. No extra software needed.
...
related:
  ...
  - text: "Remap the page-turn buttons on the PocketBook Era"
    href: /devices/pocketbook/pocketbook-era/customization/key-mapping/
steps:
  ...
  - instruction: Connect the Era to your computer
    detail: >-
      Use the USB-C cable and accept the connection prompt. The Era appears as a
      drive.
  ...
  - instruction: Select the font while reading
    ...
    tip: >-
      ...
      Era does not read. Convert it to .ttf or .otf first.
---
