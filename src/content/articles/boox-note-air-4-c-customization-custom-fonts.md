---
title: Add your own fonts to the BOOX Note Air 4 C
...
searchTerms:
  ...
  - add font
related:
  - text: "BOOX Note Air 4 C customization"
    href: /devices/boox/boox-note-air-4-c/customization/
  - text: "Get books and PDFs onto the BOOX Note Air 4 C with Calibre"
    href: /devices/boox/boox-note-air-4-c/calibre/send-books/
steps:
  ...
  - instruction: Copy them to the BOOX fonts folder
    detail: >-
      Connect the Note Air 4 C by USB in "File transfer" mode, or use a microSD
  ...
  - instruction: Select the font in NeoReader
    detail: >-
      ...
      the font settings, and pick your font — added fonts appear alongside the
      built-in ones. You can also set a default font for all books in NeoReader's
      settings.
...
Fonts on the Note Air 4 C work at two levels: the BOOX "fonts" folder feeds the
stock NeoReader app, and each third-party reading app has its own font folder and
picker. There is no single system-wide reading font, so if you use more than one
app you may need to add the font in each. File naming does not matter the way it
does on a Kobo — the apps read the family from inside the file.
