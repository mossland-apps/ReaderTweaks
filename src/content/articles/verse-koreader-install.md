---
title: Install KOReader on the PocketBook Verse
pageSlug: install
device: pocketbook-verse
section: koreader
type: guide
order: 1
summary: Copy KOReader's application file into the Verse's applications folder. It appears in the PocketBook app menu — no jailbreak, and the stock reader is untouched.
...
prerequisites:
  - text: "KOReader on the PocketBook Verse — what it adds and what it doesn't"
    href: /devices/pocketbook/pocketbook-verse/koreader/
nextStep:
  text: More KOReader guides for the Verse
  href: /devices/pocketbook/pocketbook-verse/koreader/
related:
  - text: "What is KOReader, and should you install it?"
    href: /guides/what-is-koreader/
  - text: "PocketBook Verse won't turn on or is frozen"
    href: /devices/pocketbook/pocketbook-verse/troubleshooting/wont-turn-on/
searchTerms:
  ...
  - system applications
steps:
  - instruction: Update the Verse to the current firmware first
    detail: >-
  ...
  - instruction: "If you have a .pbi file: copy it to the device and run it"
    detail: >-
      ...
      folder if it is not there). Eject and unplug. On the Verse, open the
  ...
  - instruction: Eject the drive and unplug
    detail: >-
      ...
      Verse re-scans its applications.
  - instruction: Open KOReader from the app menu
    detail: >-
      On the Verse, open the Applications menu from the home screen. "KOReader"
      is listed with the built-in apps. Open it; the first launch takes 10 to 20
  ...
  - instruction: Set the buttons up inside KOReader
    detail: >-
      ...
      "Physical buttons", and assign the two page-turn buttons and their long
      presses there.
---
