---
title: Custom templates on the reMarkable Paper Pro
...
searchTerms:
  ...
  - cornell notes
related:
  - text: "reMarkable Paper Pro customization"
    href: /devices/remarkable/remarkable-paper-pro/customization/
...
steps:
  - instruction: Use the built-in templates first
    detail: >-
      Open a notebook, open the page menu, and choose "Template". The built-in set
      is large — lined at several spacings, dotted, grid, checklists, planners,
      music, storyboard and more. Each page can use a different one, so try these
      before going further; most needs are covered.
  ...
  - instruction: Restart the interface and test
    detail: >-
      ...
      in the category you set. Draw on it to confirm it sits behind your ink.
  - instruction: Expect to re-apply after firmware updates
    detail: >-
      ...
      quickly. Community tools exist to automate this; check the reMarkable
      community resources.
---
