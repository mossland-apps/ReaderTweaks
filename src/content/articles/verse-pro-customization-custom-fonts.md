---
title: Add your own fonts to the PocketBook Verse Pro
pageSlug: custom-fonts
device: pocketbook-verse-pro
section: customization
type: guide
order: 1
summary: Copy TrueType or OpenType fonts to a folder on the Verse Pro and select them from the reading menu. No extra software needed.
...
related:
  ...
  - text: "Remap the page-turn buttons on the PocketBook Verse Pro"
    href: /devices/pocketbook/pocketbook-verse-pro/customization/key-mapping/
steps:
  ...
  - instruction: Connect the Verse Pro to your computer
    detail: >-
      Use the USB-C cable and accept the connection prompt. The Verse Pro
      appears as a drive.
  ...
  - instruction: Eject the drive and unplug
    detail: >-
      ...
      Verse Pro rebuilds its font list.
  - instruction: Select the font while reading
    ...
    tip: >-
      ...
      Verse Pro does not read. Convert it to .ttf or .otf first.
---
