---
title: Install KOReader on the PocketBook Verse Pro
pageSlug: install
device: pocketbook-verse-pro
section: koreader
type: guide
order: 1
summary: Copy KOReader's application file into the Verse Pro's applications folder. It appears in the PocketBook app menu — no jailbreak, and the stock reader is untouched.
...
prerequisites:
  - text: "KOReader on the PocketBook Verse Pro — what it adds and what it doesn't"
    href: /devices/pocketbook/pocketbook-verse-pro/koreader/
nextStep:
  text: More KOReader guides for the Verse Pro
  href: /devices/pocketbook/pocketbook-verse-pro/koreader/
related:
  - text: "What is KOReader, and should you install it?"
    href: /guides/what-is-koreader/
  - text: "PocketBook Verse Pro won't turn on or is frozen"
    href: /devices/pocketbook/pocketbook-verse-pro/troubleshooting/wont-turn-on/
searchTerms:
  ...
  - system applications
steps:
  - instruction: Update the Verse Pro to the current firmware first
    detail: >-
  ...
  - instruction: Connect the Verse Pro to your computer
    detail: >-
  ...
  - instruction: "If you have a .pbi file: copy it to the device and run it"
    detail: >-
      ...
      folder if it is not there). Eject and unplug. On the Verse Pro, open the
  ...
  - instruction: Eject the drive and unplug
    detail: >-
      ...
      Verse Pro re-scans its applications.
  - instruction: Open KOReader from the app menu
    detail: >-
      On the Verse Pro, open the Applications menu from the home screen.
