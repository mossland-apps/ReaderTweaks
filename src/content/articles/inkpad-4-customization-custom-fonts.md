---
title: Add your own fonts to the PocketBook InkPad 4
pageSlug: custom-fonts
device: pocketbook-inkpad-4
section: customization
type: guide
order: 1
summary: Copy TrueType or OpenType fonts to a folder on the InkPad 4 and select them from the reading menu. No extra software needed.
...
searchTerms:
  ...
  - system fonts
related:
  - text: "PocketBook InkPad 4 customization"
    href: /devices/pocketbook/pocketbook-inkpad-4/customization/
  - text: "Remap the page-turn buttons on the PocketBook InkPad 4"
    href: /devices/pocketbook/pocketbook-inkpad-4/customization/key-mapping/
steps:
  ...
  - instruction: Connect the InkPad 4 to your computer
    detail: >-
      Use the USB-C cable and accept the connection prompt. The InkPad 4 appears
      as a drive.
  ...
  - instruction: Eject the drive and unplug
    detail: >-
      ...
      InkPad 4 rebuilds its font list.
  - instruction: Select the font while reading
    ...
    tip: >-
      ...
      InkPad 4 does not read. Convert it to .ttf or .otf first.
---
