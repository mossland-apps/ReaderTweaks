---
title: Add your own fonts to the BOOX Page
...
searchTerms:
  ...
  - add font
related:
  - text: "BOOX Page customization"
    href: /devices/boox/boox-page/customization/
  - text: "Get books onto the BOOX Page with Calibre"
    href: /devices/boox/boox-page/calibre/send-books/
steps:
  ...
  - instruction: Copy them to the BOOX fonts folder
    detail: >-
      Connect the Page by USB in "File transfer" mode, or use a microSD card. In
...
Fonts on the Page work at two levels: the BOOX "fonts" folder feeds the stock
