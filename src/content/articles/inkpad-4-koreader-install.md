---
title: Install KOReader on the PocketBook InkPad 4
pageSlug: install
device: pocketbook-inkpad-4
section: koreader
type: guide
order: 1
summary: Copy KOReader's application file into the InkPad 4's applications folder. It appears in the PocketBook app menu — no jailbreak, and the stock reader is untouched.
...
prerequisites:
  - text: "KOReader on the PocketBook InkPad 4 — what it adds and what it doesn't"
    href: /devices/pocketbook/pocketbook-inkpad-4/koreader/
nextStep:
  text: More KOReader guides for the InkPad 4
  href: /devices/pocketbook/pocketbook-inkpad-4/koreader/
related:
  - text: "What is KOReader, and should you install it?"
    href: /guides/what-is-koreader/
  - text: "PocketBook InkPad 4 won't turn on or is frozen"
    href: /devices/pocketbook/pocketbook-inkpad-4/troubleshooting/wont-turn-on/
searchTerms:
  ...
  - system applications
steps:
  - instruction: Update the InkPad 4 to the current firmware first
    detail: >-
  ...
  - instruction: Connect the InkPad 4 to your computer
    detail: >-
  ...
  - instruction: "If you have a .pbi file: copy it to the device and run it"
    detail: >-
      ...
      folder if it is not there). Eject and unplug. On the InkPad 4, open the
  ...
  - instruction: Eject the drive and unplug
    detail: >-
      ...
      InkPad 4 re-scans its applications.
  - instruction: Open KOReader from the app menu
    detail: >-
      On the InkPad 4, open the Applications menu from the home screen.
      "KOReader" is listed with the built-in apps. Open it; the first launch
      takes 10 to 20 seconds. To leave KOReader, use its top menu and choose
      exit, which returns you to the PocketBook interface.
    tip: >-
...
4 the payoff is its PDF tools — the reason many people put KOReader on a
large-screen reader in the first place.
