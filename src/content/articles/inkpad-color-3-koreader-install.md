---
title: Install KOReader on the PocketBook InkPad Color 3
pageSlug: install
device: pocketbook-inkpad-color-3
section: koreader
type: guide
order: 1
summary: Copy KOReader's application file into the InkPad Color 3's applications folder. It appears in the PocketBook app menu — no jailbreak, and the stock reader is untouched.
...
prerequisites:
  - text: "KOReader on the PocketBook InkPad Color 3 — what it adds and what it doesn't"
    href: /devices/pocketbook/pocketbook-inkpad-color-3/koreader/
nextStep:
  text: More KOReader guides for the InkPad Color 3
  href: /devices/pocketbook/pocketbook-inkpad-color-3/koreader/
related:
  - text: "What is KOReader, and should you install it?"
    href: /guides/what-is-koreader/
  - text: "PocketBook InkPad Color 3 won't turn on or is frozen"
    href: /devices/pocketbook/pocketbook-inkpad-color-3/troubleshooting/wont-turn-on/
searchTerms:
  ...
  - system applications
steps:
  - instruction: Update the InkPad Color 3 to the current firmware first
    detail: >-
  ...
  - instruction: Connect the InkPad Color 3 to your computer
    detail: >-
  ...
  - instruction: "If you have a .pbi file: copy it to the device and run it"
    detail: >-
      ...
      folder if it is not there). Eject and unplug. Open the Applications menu,
      open the ".pbi" entry, and confirm the install. It unpacks KOReader and
  ...
  - instruction: Eject the drive and unplug
    detail: >-
      ...
      InkPad Color 3 re-scans its applications.
  - instruction: Open KOReader from the app menu
    detail: >-
      Open the Applications menu from the home screen. "KOReader" is listed with
      the built-in apps. Open it; the first launch takes 10 to 20 seconds. To
      leave KOReader, use its top menu and choose exit, which returns you to the
      PocketBook interface.
    tip: >-
  ...
  - instruction: Set the buttons up inside KOReader
    detail: >-
      ...
      "Physical buttons", and assign the two bottom page-turn buttons and their
      long presses there.
---
...
between the two by opening or closing KOReader from the app menu. On the InkPad
Color 3 KOReader keeps colour and adds better comic and PDF handling.
