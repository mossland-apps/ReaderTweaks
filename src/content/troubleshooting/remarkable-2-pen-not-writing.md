---
title: The reMarkable Marker isn't writing or is lagging on the reMarkable 2
...
beforeYouStart:
  ...
  - Confirm the Marker is a reMarkable 2 generation pen — the Paper Pro's newer Markers do not work on the reMarkable 2.
...
decisionTree:
  ...
  branches:
    ...
    - label: The eraser or shortcut button does not work
      ...
      href: "#fix-3"
fixes:
  - title: Restart the reMarkable 2 and re-pair the Marker
    rationale: >-
    ...
    steps:
      ...
      - >-
        Confirm the Marker is a reMarkable 2 generation pen. The Paper Pro,
        Paper Pro Move and Paper Pure Markers use different technology and will
        not work here.
  - title: Replace the Marker tip
    ...
    steps:
      ...
      - >-
        Order more tips when you are down to your last one. The reMarkable 2's
        Marker and Marker Plus use the same tips as each other, but not the same
        as the newer Paper Pro generation — check the pack lists the reMarkable 2.
    note: >-
  ...
  - title: Fix the Marker Plus eraser or shortcut button
    ...
    steps:
      ...
      - >-
        ...
        then "Software" — unless you are deliberately holding an older firmware
        for community software.
      - >-
        Restart the device. If the eraser still does nothing, contact reMarkable
        — a Marker Plus with a dead eraser is usually replaced under warranty if
...
recovery: >-
  ...
  may be faulty. A replacement reMarkable 2 Marker is inexpensive and widely
  available if the original is out of warranty.
related:
...
most of the time. If it makes no marks at all or lags, restart the reMarkable 2,
and confirm the Marker is a reMarkable 2 generation pen, since the newer Paper
Pro Markers do not work here.
