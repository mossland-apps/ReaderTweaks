---
title: The BOOX Go 6 battery drains fast
pageSlug: battery-drains-fast
device: boox-go-6
software: BOOX firmware
summary: >-
  The Go 6 loses charge quickly even when idle. On an Android e-reader this is
...
beforeYouStart:
  - The Go 6's small battery means standby matters more here than on a larger BOOX; it should still last many days.
...
related:
  ...
  - text: "The BOOX Go 6 won't turn on or is frozen"
    href: /devices/boox/boox-go-6/troubleshooting/wont-turn-on/
---

Start by turning Wi-Fi off between syncs and restricting background apps — that
alone brings most Go 6 units back to many days of standby. If it is still bad,
