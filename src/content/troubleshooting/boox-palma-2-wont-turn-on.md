---
title: The BOOX Palma 2 won't turn on or is frozen
...
symptoms:
  ...
  - The screen is frozen and touch does nothing.
...
mostCommonCause: >-
  The most common cause is a fully drained battery — the Palma 2 can sit with no
  response for 15 to 30 minutes on the charger before it shows life. The next
...
fixes:
  - title: Charge it, then force a restart
    rationale: >-
      ...
      charge, and the Palma 2's screen stays dark the whole time.
    steps:
  ...
  - title: Force a restart, and use recovery for a boot loop
    ...
    steps:
      ...
      - In recovery, choose "wipe cache partition" — this does not delete your apps or books. Then "reboot system now".
...
recovery: >-
  ...
  reset erases everything on the device — installed apps, their data, and any
  books in internal storage — but not books on a microSD card, and not anything
  already synced to a cloud account. Back up sideloaded books before a reset. If
  nothing revives the device, contact BOOX support.
related:
  - text: "Set up a new BOOX Palma 2"
    href: /devices/boox/boox-palma-2/guides/first-setup/
  - text: "The BOOX Palma 2 battery drains fast"
    href: /devices/boox/boox-palma-2/troubleshooting/battery-drains-fast/
---
