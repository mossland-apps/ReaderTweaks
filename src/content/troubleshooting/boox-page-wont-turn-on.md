---
title: The BOOX Page won't turn on or is frozen
...
fixes:
  - title: Charge it, then force a restart
    rationale: >-
      ...
      charge, and the Page's screen stays dark the whole time.
    steps:
      - >-
  ...
  - title: Force a restart, and use recovery for a boot loop
    ...
    steps:
      ...
      - In recovery, choose "wipe cache partition" — this does not delete your apps or books. Then choose "reboot system now".
      - If the loop continues after a cache wipe, the next option in recovery is a factory reset, which does erase the device — see recovery notes below.
...
related:
  - text: "Set up a new BOOX Page"
    href: /devices/boox/boox-page/guides/first-setup/
  - text: "The BOOX Page battery drains fast"
    href: /devices/boox/boox-page/troubleshooting/battery-drains-fast/
---
