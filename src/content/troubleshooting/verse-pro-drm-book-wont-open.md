---
title: A DRM-protected library book won't open on the PocketBook Verse Pro
...
summary: >-
  ...
  Verse Pro signed in to an Adobe ID.
difficulty: Moderate
...
symptoms:
  ...
  - A library book opened on another device but not on the Verse Pro.
beforeYouStart:
...
mostCommonCause: >-
  The Verse Pro can open Adobe-DRM library books, but only once it is
...
decisionTree:
  ...
  branches:
    ...
    - label: "Adobe sign-in itself fails with an activation limit"
      ...
      href: "#fix-2"
fixes:
  - title: Authorise the Verse Pro with an Adobe ID
    rationale: >-
    ...
    steps:
      - >-
        On the Verse Pro, open Settings, then "Accounts and Synchronization",
        then "Adobe DRM".
      - >-
    ...
    note: >-
      ...
      any computer, and the Verse Pro — so books unlock on all of them.
  - title: Make sure the book was fulfilled to the right Adobe ID
    rationale: >-
      ...
      one now on the device, the Verse Pro cannot open it, and re-authorising to
      a new ID does not retroactively unlock older books.
    steps:
      - >-
      ...
      - >-
        Sign the Verse Pro in to that same Adobe ID (Settings, then Accounts and
  ...
  - title: Complete the download from the ".acsm" file on the device
    rationale: >-
      ...
      exchanges for the actual book. Copying the ".acsm" onto the Verse Pro and
    ...
    steps:
      ...
      - >-
        Copy just the ".acsm" file to the Verse Pro by USB, into any folder.
      - >-
        On the device, open the ".acsm" from the Library. With Adobe DRM
        authorised (Fix 1), the Verse Pro contacts Adobe, downloads the real
      ...
      - >-
        ...
        app and use its "Send to device" option, which hands the Verse Pro a
        book already tied to your Adobe ID.
recovery: >-
...
related:
  ...
  - text: "Get books onto the PocketBook Verse Pro"
    href: /devices/pocketbook/pocketbook-verse-pro/guides/get-books-on/
---

The Verse Pro is one of the few readers that opens Adobe-DRM library books
without a computer, but only after it is signed in to an Adobe ID — and the book
has to have been issued to that same ID. Fix 1 covers a device that was never
