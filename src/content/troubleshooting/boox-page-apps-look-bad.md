---
title: Apps look grey, blurry or ghosted on the BOOX Page
...
fixes:
  - title: Fix the global refresh mode
    ...
    steps:
      ...
      - >-
        Set it to "HD" or "Regal" — the Page is a reading device, so there is
        little reason to run it faster globally. Do not leave it on "Fast",
        "Speed", "Ultrafast" or "A2".
  ...
  - title: Optimise the specific app that looks bad
    ...
    steps:
      ...
      - If the app's layout is tiny or huge, adjust the DPI slider, then reopen the app.
  ...
  - title: Deal with ghosting and rule out a hardware fault
    ...
    steps:
      - >-
        ...
        pages" to 1 for the cleanest result, or 3 to 5 as a compromise.
      - >-
...
recovery: >-
  ...
  control centre lets you set the global mode back. Nothing here touches your
  books or apps.
related:
