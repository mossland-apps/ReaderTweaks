---
title: The reMarkable Paper Pro won't turn on or is frozen
...
beforeYouStart:
  - Use a charger and cable you know work; the Paper Pro's large battery needs a real charger, not a weak port.
...
mostCommonCause: >-
  The most common cause is a fully drained battery — the Paper Pro has a large
...
fixes:
  - title: Charge it on a real charger, then force a restart
    rationale: >-
      A deeply discharged Paper Pro gives no response until it has taken on
    ...
    note: >-
      ...
      Paper Pro, because of its battery size.
  ...
  - title: Recover a device that will not boot after an update or modification
    ...
    steps:
      - >-
        ...
        symptoms and your serial number. They can often walk you through a
        recovery, and a genuine boot failure on an unmodified device is a warranty
        matter.
      - >-
        ...
        had synced.
      - >-
        The reMarkable community maintains recovery guides for bricked devices;
        follow one matched to your exact model and firmware, and only if you are
...
recovery: >-
  ...
  critical as a PDF.
related:
  - text: "Set up a new reMarkable Paper Pro"
    href: /devices/remarkable/remarkable-paper-pro/guides/first-setup/
  - text: "Notebooks or documents aren't syncing on the reMarkable Paper Pro"
    href: /devices/remarkable/remarkable-paper-pro/troubleshooting/syncing/
---
...
reMarkable's recovery process or support.
