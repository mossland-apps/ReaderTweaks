---
title: The reMarkable Marker isn't writing or is lagging
...
beforeYouStart:
  ...
  - Note whether the problem is everywhere, or only in one notebook or PDF.
...
decisionTree:
  ...
  branches:
    ...
    - label: The eraser or shortcut button does not work
      ...
      href: "#fix-3"
fixes:
  - title: Restart the Paper Pro and re-pair the Marker
    rationale: >-
    ...
    steps:
      ...
      - >-
        If there is still no response anywhere, fit the spare tip from the box in
        case the current one is damaged, then move to Fix 2.
  - title: Replace the Marker tip
    ...
    steps:
      ...
      - >-
        Test on a notebook page. Writing should feel light again and lines should
        be unbroken.
      - >-
        Order more tips when you are down to your last one. reMarkable and
        third parties sell tip packs; the Marker and Marker Plus use the same
        tips.
    note: >-
  ...
  - title: Fix the Marker Plus eraser or shortcut button
    ...
    steps:
      ...
      - >-
        ...
        then "Software". Eraser and button behaviour has been fixed in past
        updates.
      - >-
        Restart the device. If the eraser still does nothing after a restart and a
        firmware check, contact reMarkable — a Marker Plus with a dead eraser is
...
most of the time and takes a minute. If it makes no marks at all or lags, restart
the Paper Pro before assuming anything is broken.
